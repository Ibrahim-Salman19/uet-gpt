...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--surface-card)] text-[var(--text-primary)] shadow-[var(--shadow-sm)] transition-shadow duration-[var(--duration-normal)] ease-[var(--ease-out-quart)]",
        className,
      )}
      {...props}
    />
