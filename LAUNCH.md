...
Try it free at https://uet-gpt.vercel.app. No credit card needed.

### Long Description (AI Directories)
...
### Tags (Use 5-8 per directory)
AI chatbot, UET Taxila, educational AI, RAG chatbot, university assistant, Pakistani engineering, student tools, EdTech
...
| Fazier | https://fazier.com/submit | ~30 |
| Microlaunch | https://microlaunch.net/submit | ~30 |
| OpenHunts | https://openhunts.com/submit | ~25 |
| Uneed | https://app.uneed.best/submit | ~40 |
| PeerPush | https://peerpush.io/submit | ~25 |
| LaunchVault | https://launchvault.co/submit | ~20 |
| Firsto | https://firsto.io/submit | ~25 |
| PitchWall | https://pitchwall.co/submit | ~25 |
| What Launched Today | https://whatlaunchedtoday.com/submit | ~20 |
...
| Futurepedia | https://www.futurepedia.io/submit-tool | DR 70, 1M/mo |
| Toolify | https://www.toolify.ai/submit | DR 71, 500K/mo |
| Future Tools | https://futuretools.io/submit | DR 69, 400K/mo |
| AI Tools Neilpatel | https://ai-tools.neilpatel.com/submit | DR 91 |
| aitools.inc | https://aitools.inc/submit | ~66 |
| AIStage | https://aistage.co/submit | ~66 |
...
| AlternativeTo | https://alternativeto.net/submit/ | 79 |
| SourceForge | https://sourceforge.net/create/ | 92 |
| Slashdot | https://slashdot.org/submission | ~88 |
| Startup Stash | https://startupstash.com/submit | ~50 |
...
| Hashnode | https://hashnode.com/ | 85 |
| About.me | https://about.me/ | 85 |
| WordPress.com | https://wordpress.com/ | 100 |
| Tumblr | https://tumblr.com/ | 99 |

---

## Google Search Console Setup
1. Go to https://search.google.com/search-console
2. Add property: URL prefix → `https://uet-gpt.vercel.app`
3. Verify ownership via:
   - **Option A**: DNS TXT record (if you have domain access)
   - **Option B**: HTML file upload to `/public/` directory
   - **Option C**: Google Analytics (if GA4 is set up)
4. Submit sitemap: `https://uet-gpt.vercel.app/sitemap.xml`
5. Check Index Coverage report weekly

---

## LinkedIn Company Page Setup
1. Go to https://www.linkedin.com/company/setup/new/
2. Company name: UET GPT
3. Website: https://uet-gpt.vercel.app
4. Industry: E-Learning / Education Technology
5. Description (use AI directory variant above)
6. Logo: Use UET GPT branding
7. Start posting content weekly

---

## Crunchbase Profile Setup
1. Go to https://www.crunchbase.com/add/organization
2. Name: UET GPT
3. Short description: AI-powered RAG chatbot for UET Taxila
4. Website: https://uet-gpt.vercel.app
5. Categories: Education, Artificial Intelligence, Chatbot
6. Founded: May 2026
7. Headquarters: Taxila, Punjab, Pakistan

---

## Wikidata Entry Fields
| Property | Value |
|---|---|
| Label | UET GPT |
| Description | AI-powered RAG chatbot for the University of Engineering and Technology, Taxila |
...
| Metric | Week 1 | Month 1 | Month 2 |
|---|---|---|---|
| Directories submitted | 15 | 40 | 70+ |
| Wikidata | created | verified | maintained |
| Crunchbase | created | complete | cross-linked |
| LinkedIn | created | weekly posts | 10+ employees |
| Google indexed pages | verify | 50+ | 200+ |
| AI citations (manual check) | baseline | 5+ | 15+ |

---

## AI Visibility Check (Monthly)
Query each of these in ChatGPT, Perplexity, and Claude:
1. "what is UET Taxila"
2. "UET Taxila admission requirements"
3. "UET Taxila fee structure"
4. "UET Taxila chatbot"
5. "best AI tools for Pakistani students"
6. "UET GPT"
7. "uet taxila ai assistant"

Log in a spreadsheet: Are we cited? Who is cited? What page sources?
