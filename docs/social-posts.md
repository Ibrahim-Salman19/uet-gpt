...
> **Manual posting required:** Every item below must be posted by the repo owner / maintainer. Nothing is auto-posted. Replace `[your handle]` with your actual social handle before posting.
...
>
> "What's the fee structure for BS programs?" → instant, sourced answer.
> "When do admissions open?" → pulled from the official portal.
>
> Built with RAG over official UET Taxila data. Free and open source.
> https://uet-gpt.vercel.app
>
> #UET #UETTaxila #EdTech #AI #Pakistan #Admissions
...
> How We Built UET GPT: An Open-Source RAG Chatbot for UET Taxila
...
- [ ] Reddit r/Pakistan
- [ ] UET subreddit / student groups
- [ ] dev.to article
- [ ] Submit press kit link (https://uet-gpt.vercel.app/press-kit) to relevant directories / wikis
